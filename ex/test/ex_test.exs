defmodule ExTest do
  ...
  test "that exceeding hours worked by more than 8 gives +1 on total and +0 on points" do
  ...
  test "that not exceeding hours worked by more than 8 gives +1 on total and +1 on points" do
    initial_score = %Ex.Score{points: 0, total: 0}
